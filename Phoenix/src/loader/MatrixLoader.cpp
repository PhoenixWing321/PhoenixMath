...
//------------------------------------------------------
int MatrixLoader::save(NonUniformMatrixXf& matrix, const std::string& path, Format format) const {
...
//------------------------------------------------------
int MatrixLoader::save(NonUniformMatrixXf& matrix, std::stringstream& stream, Format format) const {
